# Agent setup for `codex-translator-chrome-extension`

This is a deepsec scanning workspace. Project `codex-translator-chrome-extension` was just registered
(target: `..`). Setup is incomplete — `data/codex-translator-chrome-extension/INFO.md`
...
2. **Fill in `data/codex-translator-chrome-extension/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id codex-translator-chrome-extension
pnpm deepsec process --project-id codex-translator-chrome-extension
```
